...
public void OnPluginStart()
{
	...
	h_GameDesc = CreateConVar("sm_tf2zm_gamdesc", "Zombie-Land", "What to override game description to");
...
{
	GetConVarString(h_GameDesc, sGameDesc, 128);
}
...
public Action TF2_RoundStart(Handle event, const char[] name, bool dontBroadcast)
{
	if(GetConVarBool(h_Enable))
	{
		...
		CreateTimer(GetConVarFloat(h_cInterval), MoveToBlue, _, TIMER_FLAG_NO_MAPCHANGE);
...
public Action MoveToBlue(Handle timer)
{
