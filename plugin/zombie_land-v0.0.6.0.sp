...
public void OnPluginStart()
{
	...
	h_MapPrefix = CreateConVar("sm_zl_prefixes", "zf_,zl_", "Specify map prefixes for when the plugin should activate. (seperate with comma ',')");
